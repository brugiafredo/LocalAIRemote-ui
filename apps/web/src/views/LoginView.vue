...
<template>
  <main class="auth-page">
    <form class="auth-card" @submit.prevent="submit">
      ...
      <h1 class="mt-2 text-center text-2xl font-semibold">Sign in to Escarlet Local AI UI</h1>
      <p class="mt-2 text-center text-sm text-muted">Enter the password configured on the Escarlet Local AI UI server.</p>
