...
const definitions: Array<{ capability: ModelCapability; icon: string; label: string; supported: string; unsupported: string }> = [
  ...
  { capability: "tools", icon: "⌘", label: "Tools", supported: "Tools — this model reports tool-call support, but Local AI tool execution is not enabled yet.", unsupported: "Tools — this model does not report tool-call support." },
